            ...
            <main className="flex min-h-screen flex-col bg-white pt-8 pb-0">
                ...
                <section className="flex flex-1 flex-col lg:hidden">
                    ...
                    <div className="mt-2 flex flex-1 flex-col gap-6 px-6 py-8 sm:px-8">
                        ...
                        <button type="button" className="flex justify-center w-39.75 cursor-pointer rounded-lg bg-mint-dark px-3 py-2 text-base font-bold text-white hover:bg-mint-dark/90">
                            Generar QR
                        </button>
                        </div>
							...
							<div className="mt-14 flex flex-col gap-4">
								{Array.from({ length: 3 }, (_, index) => (
									<button
										key={index}
										type="button"
										className="rounded border border-border px-3 py-2 text-left text-text-primary font-bold text-[14px]  hover:border-mint-dark"
									>
										Mesa #{index + 10}
									</button>
								))}
