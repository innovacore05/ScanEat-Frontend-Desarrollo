				...
				<section className="flex flex-1 flex-col lg:hidden">
					...
					<div className="mt-2 flex flex-1 flex-col gap-6 px-6 py-8 sm:px-8">
						...
						<div className="flex gap-4 align-center justify-end mt-3">
							<button type="button" onClick={handleGenerateQr} className="flex justify-center w-39.75 cursor-pointer rounded-lg bg-brand-mint-dark px-3 py-2 text-base font-bold text-white hover:bg-brand-mint-dark/90">
								Generar QR
							</button>
							<QrCodeModal
